import { Asset, AssetSummary, AssetSearch as AssetSearchModel, Location, AssetCategory, User } from '@/types/models';
...
export const sampleAssetCategories: AssetCategory[] = [
  {
    id: 'CAT001',
